...
def get_product_details(url):
    ...
    try:
        product_description = driver.find_element(By.XPATH, "//*[@id='feature-bullets']").text
    except:
        product_description = None

    try:
        asin_number = driver.find_element(By.CSS_SELECTOR, "#detailBullets_feature_div ul li:nth-child(4) span span:nth-child(2)").text
    except:
        asin_number = None

    try:
        manufacturer_name = driver.find_element(By.CSS_SELECTOR, "#detailBullets_feature_div ul li:nth-child(3) span span:nth-child(2)").text
    except:
        manufacturer_name = None

    try:
        Discription = driver.find_element(By.CSS_SELECTOR, ".a-section.feature.detail-bullets-wrapper.bucket").text
    except:
        Discription = None
